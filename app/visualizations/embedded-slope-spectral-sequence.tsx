...
export function EmbeddedSlopeSpectralSequence() {
  ...
  return (
    <iframe
      ...
      ref={frameRef}
      src="/visualizations/domino/slope-spectral-sequence/index.html"
      style={{ height: `${frameHeight}px` }}
      title="Slope Spectral Sequence interactive visualization"
    />
  );
}
